...
type ReturnsData = {
  range: { from: string; to: string }; granularity: string; dataThrough?: string | null; dimensions: Dimensions; soldUnits: number; returnedUnits: number;
