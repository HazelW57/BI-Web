...
function tables(store:Store){const prefix=store==="JS"?"bby_js":"bby_sap";return{sales:`${prefix}_sales_lines`,returns:`${prefix}_return_lines`,windows:`${prefix}_sync_windows`,credentials:`${prefix}_credentials`,prefix};}
